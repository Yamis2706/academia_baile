...
public class ClienteConstantes {
    public static final String MENSAJE_CREAR_CLIENTE = "Ha seleccionado la opción 1 - Crear Cliente"
    ...
    public static final String INGRESE_CEDULA_CLIENTE = "Ingrese la cédula del cliente";
    public static final String INGRESE_CEDULA_CLIENTE_BUSCAR = "Ingrese la cédula del cliente que" +
            " desea buscar";
    public static final String INGRESE_CEDULA_CLIENTE_ACTUAL = "Ingrese la cédula actual del cliente";
    ...
    public static final String CLIENTE_NO_ACTUALIZADO = "No se pudo actualizar el cliente, " +
            "no existe ¡¡¡";
    public static final String CLIENTE_PARA_ACTUALIZAR = "Digite el número de cédula del cliente que" +
            " desea actualizar:" + "\n" + "\n";
    public static final String CLIENTE_PARA_ELIMINAR = "Para eliminar el cliente, por favor digitar" +
            " el número de cédula:" + "\n" + "\n";
}